...
import StageDocumentAttachment from './_components/StageDocumentAttachment';
      ...
      <div id="case-review-card" className="bg-white rounded-2xl border border-slate-200 p-6 sm:p-7 shadow-xs space-y-3">
        ...
        <div className="pt-2">
          <StageDocumentAttachment
            ...
            stage="Case Review"
            title="Case Review Supplementary Documents"
            description="Attach specialist assessments, clinical opinions, or diagnostic summaries to supplement your evaluation text."
        ...
        <div className="flex flex-wrap items-center justify-between gap-2 px-1">
          <div className="flex items-center gap-2">
            ...
            <h3 className="text-xs font-bold uppercase tracking-wider text-slate-700">
              Journey Dashboard Components &amp; Workstations
            </h3>
          </div>
          <span className="text-xs font-semibold text-slate-500">
            Current Case Stage: <strong className="text-emerald-700">{caseRecord.workflow_stage || caseRecord.stage}</strong>
          </span>
        </div>
        <div className="flex items-center gap-2 overflow-x-auto py-1 scrollbar-none">
          {[
            { id: 'Hospital Recommendation', label: 'Hospital Recommendation', icon: Building2 },
            { id: 'Medical Itinerary', label: 'Medical Itinerary', icon: Calendar },
            { id: 'Accommodation & Visa', label: 'Accommodation & Visa', icon: Hotel },
            { id: 'Travel Preparation', label: 'Travel Preparation', icon: Plane },
            { id: 'Treatment & Recovery', label: 'Treatment & Recovery', icon: Activity },
          ].map((tab) => {
            const Icon = tab.icon;
        ...
        {activeWorkstationTab === 'Hospital Recommendation' && (
          <div className="space-y-4">
            ...
            <StageDocumentAttachment
              ...
              title="Hospital & Specialist Supplementary Documents"
              description="Attach hospital brochures, surgeon profiles, cost estimates, or treatment packages to supplement your recommendations."
              onUpdateCase={handleChildUpdateCase}
              showToast={showToast}
            />
          </div>
        ...
        {activeWorkstationTab === 'Medical Itinerary' && (
          <div className="space-y-4">
            ...
            <StageDocumentAttachment
              ...
              title="Medical Itinerary Supplementary Documents"
              description="Attach appointment confirmations, treatment calendars, clinical schedules, or hospital admission slips."
              onUpdateCase={handleChildUpdateCase}
              showToast={showToast}
            />
          </div>
        ...
        {activeWorkstationTab === 'Accommodation & Visa' && (
          <div className="space-y-4">
            ...
            <StageDocumentAttachment
              ...
              title="Accommodation & Visa Supplementary Documents"
              description="Attach visa invitation letters, medical visa requirement checklists, hotel vouchers, or booking receipts."
              onUpdateCase={handleChildUpdateCase}
              showToast={showToast}
            />
          </div>
        ...
        {activeWorkstationTab === 'Travel Preparation' && (
          <div className="space-y-4">
            ...
            <StageDocumentAttachment
              ...
              title="Travel Preparation Supplementary Documents"
              description="Attach flight tickets, airport transfer details, packing guidelines, or pre-departure checklists."
              onUpdateCase={handleChildUpdateCase}
              showToast={showToast}
            />
          </div>
        ...
        {activeWorkstationTab === 'Treatment & Recovery' && (
          <div className="space-y-4">
            ...
            <StageDocumentAttachment
              ...
              title="Treatment & Recovery Supplementary Documents"
              description="Attach discharge summaries, operative reports, post-procedure rehabilitation guides, or prescription records."
              onUpdateCase={handleChildUpdateCase}
              showToast={showToast}
            />
          </div>
